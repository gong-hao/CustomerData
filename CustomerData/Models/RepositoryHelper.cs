namespace CustomerData.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_簡易報表Repository Getvw_簡易報表Repository()
		{
			var repository = new vw_簡易報表Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_簡易報表Repository Getvw_簡易報表Repository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_簡易報表Repository();
